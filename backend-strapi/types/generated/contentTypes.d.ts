...
export interface ApiExpenseExpense extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    fertilization: Attribute.Float;
    orchard: Attribute.Relation<
      'api::expense.expense',
      'manyToOne',
      'api::orchard.orchard'
    >;
...
export interface ApiHarvestHarvest extends Schema.CollectionType {
  ...
  attributes: {
    note: Attribute.Text;
    harvest_amount: Attribute.Decimal;
    date_of_harvest: Attribute.Date;
    orchard: Attribute.Relation<
      'api::harvest.harvest',
      'manyToOne',
      'api::orchard.orchard'
...
export interface ApiOrchardOrchard extends Schema.CollectionType {
  ...
  attributes: {
    ...
    olive_trees: Attribute.Integer;
    percentage_of_oil: Attribute.String;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::orchard.orchard': ApiOrchardOrchard;
